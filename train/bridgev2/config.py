...
DATASETS = [
    "/home/yupeiqi/bridge_data_v2/raw_pkl"
]
...
def get_args():
    ...
    model_arg.add_argument('--model_type', type=str, default='dt')  # dt for decision transformer, bc for behavior cloning
    model_arg.add_argument('--env', type=str, default='hopper')
    model_arg.add_argument('--dataset', type=str, default='medium')  # medium, medium-replay, medium-expert, expert
    model_arg.add_argument('--mode', type=str, default='normal')  # normal for standard setting, delayed for sparse
    model_arg.add_argument('--max_length', type=int, default=20)
    model_arg.add_argument('--pct_traj', type=float, default=1.)
    model_arg.add_argument('--embed_dim', type=int, default=128)
    model_arg.add_argument('--n_layer', type=int, default=3)
    model_arg.add_argument('--n_head', type=int, default=1)
    model_arg.add_argument('--activation_function', type=str, default='relu')
    model_arg.add_argument('--num_steps_per_iter', type=int, default=10000)
    model_arg.add_argument('--state_dim', type=int, default=128) ###
    model_arg.add_argument('--act_dim', type=int, default=7)
    model_arg.add_argument('--max_ep_len', type=int, default=1000)
    model_arg.add_argument('--dropout', type=float, default=0.1)

    learn_arg = parser.add_argument_group('Learning')
    learn_arg.add_argument('--save_dir', type=str, default='decision_transformer_save_ckpt')
    ...
    misc_arg.add_argument('--method', type=str, default='df')
