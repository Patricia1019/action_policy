...
from encoder.resnet import resnetv1_configs
...
# def train(args, criterion, train_dataset, eval_dataset, start_step=0):
    ...
    for epoch in range(epochs):
        ...
        for data in dataloader: # len of dataset: 44037, len of dataloader: 173
            ...
            # obs_imgs = obs_imgs.to("cuda")
            # goal_imgs = goal_imgs.to("cuda")
            ...
            rewards = rewards
            # outputs = engine(obs_imgs, goal_imgs)
            state_preds, action_preds, reward_preds = engine(states, actions, rewards, returns_to_go=rewards,timesteps=10) #############TODO
