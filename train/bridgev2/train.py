...
from datasets.bridgev2.bridge_dataset import BridgeDatasetTorch
...
def train(args, engine, criterion, trainset, testset, start_step):
    rank = args.local_rank
    ...
    for epoch in range(epochs):
        ...
        dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=micro_train_batch_size, num_workers=args.num_workers)
        ...
        for data in dataloader:
            ...
            (obs_imgs, obs_pros, next_obs_imgs, next_obs_pros, actions, terminals, truncates, goal_imgs, goal_pros, rewards, masks) = data
...
if __name__ == '__main__':
    ...
    trainset = BridgeDatasetTorch(args, args.local_rank, world_size, is_train=True)
